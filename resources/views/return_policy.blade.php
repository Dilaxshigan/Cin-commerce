                ...
                <div class="row">
                    <div class="col-md-12 mb-bottom">
                        <div class="text-center animate-me-1">
                            ...
                            <h2 class="fs2 display-4 fw-semibold d-inline-block s3 text-uppercase text-white py-1">Return Policy</h2>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="container">
                    <div class="row gx-5 align-items-center fs-5">
                        <div class="col-md-12">
                            <h3>Hale Cinnamon Return Policy</h3>
                            <p>Last Updated: <strong>06.12.2024</strong></p>
                            ...
                            <p>Once we receive your returned item(s) and verify that they meet the conditions for return, we will issue a full refund to the original payment method used for your purchase. Please allow [Number] business days for your refund to be processed.</p>
                            ...
                            <ul>
                                <li>Email: <a href="mailto:youremail@example.com" class="text-decoration-none" title="Mail">mail@cinnamon.com</a></li>
